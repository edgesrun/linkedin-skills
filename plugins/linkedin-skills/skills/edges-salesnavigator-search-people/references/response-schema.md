# Sales Navigator Search People — Full Response Schema
...
| `current_company` | string | Current company (may differ from company_name in formatting) |
...
| `summary` | string | Profile summary snippet |
